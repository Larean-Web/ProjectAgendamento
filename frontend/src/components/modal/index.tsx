...
export function AddCategoy({isAdd, setIsAdd}: AppProps) {
    ...
    return (
        <div className="flex flex-col items-center w-[380px] h-[300px] border-2 border-darkblue-base bg-white">
            ...
            <div className="flex gap-10">
                <button onClick={() => setIsAdd(!isAdd)}className="bg-red-500 w-[100px] rounded-xl text-white font-bold">
                    Cancelar
                </button>
                <button
...
export function AddClient({isAdd, setIsAdd}: AppProps) {
